...
const stages = [
  ...
  },
  {
    ...
    image:
      "https://images.pexels.com/photos/1098982/pexels-photo-1098982.jpeg?auto=compress&cs=tinysrgb&w=1600",
  ...
  },
  {
    ...
    image:
      "https://images.pexels.com/photos/19963718/pexels-photo-19963718/free-photo-of-modern-house-windows.jpeg?auto=compress&cs=tinysrgb&w=1600",
...
export function SystemShowcase() {
  ...
  const step = useCallback((direction: number) => {
    setActive(
      (current) => (current + direction + stages.length) % stages.length,
    );
  }, []);
        ...
        <div className="section-heading split-heading">
          <div>
            ...
            <h2>
              Empat hal yang
              <br />
              <span>perlu diperhatikan.</span>
            </h2>
          </div>
          <p>
            Lihat bagaimana ukuran, sistem bukaan, kaca, dan detail pemasangan
            saling memengaruhi hasil akhir pekerjaan.
          </p>
        </div>
            ...
            <div className={`system-visual active-${active}`}>
              <AnimatePresence mode="wait">
                <motion.img
                  ...
                  initial={{
                    opacity: 0,
                    scale: Math.max(1, item.zoom - 0.025),
                  }}
