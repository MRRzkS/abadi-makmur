    ...
    <>
      <section className="inner-hero portfolio-page-hero section-pad dark-surface" data-nav-theme="dark">
        <div className="container portfolio-title-grid">
          <Reveal>
            ...
            <h1>Lihat jenis pekerjaan<br /><span>aluminium & kaca.</span></h1>
          </Reveal>
          <Reveal className="portfolio-disclaimer glass-panel" delay={0.08}>
            <span>CATATAN FOTO</span>
            <p>Foto pada galeri ini digunakan sebagai referensi jenis pekerjaan yang kami layani dan bukan dokumentasi proyek Abadi Makmur.</p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="section portfolio-upload-note">
        <div className="container upload-note-grid">
          <Reveal><p className="eyebrow">PUNYA KEBUTUHAN SERUPA?</p><h2>Konsultasikan pekerjaan<br /><span>aluminium & kaca Anda.</span></h2></Reveal>
          <Reveal className="upload-note" delay={0.08}>
            <p>Kirim jenis pekerjaan, lokasi, serta foto atau ukuran perkiraan bila ada. Kami bantu arahkan kebutuhan dan langkah selanjutnya melalui WhatsApp.</p>
